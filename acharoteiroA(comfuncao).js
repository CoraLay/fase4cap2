...
const regexB = /#Roteiro A(.+?)#Roteiro B/gi; 
const buscaRoteiros = text.match(regexB); 
const respostaDesejadaB = buscaRoteiros.map(match => match.replace(regexB, "$1"))
console.log("respostaDesejadaB", respostaDesejadaB); 

function exibeCidades() {
        document.write(respostaDesejadaB);
    } 
    exibeCidades();
